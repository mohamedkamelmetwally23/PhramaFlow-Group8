   ...
   <div class="col-12 col-md-12 col-xl-12 mb-3" data-id="${a.id}">
    ...
    <div class="card-body p-3">
      ...
      <div class="d-flex flex-column flex-md-row align-items-start justify-content-between mb-2 gap-2">
        ...
        <span class="badge ${badge} text-capitalize py-2">
      ...
      <div class="d-flex flex-column flex-sm-row align-items-start align-items-sm-center flex-wrap gap-2 gap-sm-3 mt-3 pt-1 ps-2">
        ...
        <span class="small text-secondary">
          <i class="fas fa-calendar-alt me-1"></i>${formatDate(a.timestamp, true) || 'N/A'}
        </span>
      </div>
